...
!function () {
    !function (yrx_r, yrx_a) {
        ...
        var yrx_R, yrx_N, yrx_V, yrx_L, yrx_Q = {
            ...
            yrx_Z = yrx_P[yrx_$(460)] || yrx_P[yrx_n(437)](yrx_n(460))[0], yrx_X = yrx_P[yrx_n(427)] || yrx_Y, yrx_tt = yrx_K[yrx_$(395)] + yrx_n(491), yrx_rt = yrx_r[yrx_n(423)],
            // 根据网站的逻辑最终赋值的结果，直接给它写死，否则就要补canvas环境
            yrx_at = false,
            yrx_nt = false,
            yrx_it = false,
            yrx_$t = false,
        ...
        console.log('模块加载...')        // *验证初始化时这个对象是不是已经加载了，并且这个对象里面有我们需要的方法
        yrx_$r[yrx_n(26)] = {
        ...
        window.to_womit = yrx_$r[yrx_n(26)];
        yrx_cr[yrx_$(26)] = {
            challenge: yrx_n(226),
            gt: yrx_n(226),
            type: yrx_n(1421),
...
// new window.yuanrenxue(ycf);    // 我们需要的模块初始化时已经加载了并且模块里的方法可以暴露给全局，所以不再需要去new这个操作了，没有意义
console.log(global.to_womit.$_BGGH())
